const YTD_OPTIONS = (() => {
  ...
  const COPY = {
    en: {
      ...
      deepseekHelp:
        "Video Digest uses DeepSeek V4 Flash for overviews, explanations, translation, and note polishing. ",
    ...
    "zh-CN": {
      ...
      deepseekHelp:
        "Video Digest 使用 DeepSeek V4 Flash 生成概览、解释内容、翻译字幕和润色笔记。",
